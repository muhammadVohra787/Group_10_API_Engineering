...
namespace BookInventoryManagement.Scripts
{
    public static class DataSeeder
    {
        public static async Task SeedAsync(ApplicationDbContext context)
        {
            ...
            {
                new BookDetails { BookId = GetId("9780743273565"), Genre = "Classic", Language = "English", PageCount = 180, Format = "Paperback", CoverImageUrl = "https://covers.openlibrary.org/b/isbn/9780743273565-L.jpg" },
                new BookDetails { BookId = GetId("9780061120084"), Genre = "Fiction", PageCount = 281, Language = "English", Format = "Paperback", CoverImageUrl = "https://covers.openlibrary.org/b/isbn/9780061120084-L.jpg" },
                new BookDetails { BookId = GetId("9780451524935"), Genre = "Dystopian", PageCount = 328, Language = "English", Format = "Paperback", CoverImageUrl = "https://covers.openlibrary.org/b/isbn/9780451524935-L.jpg" },
                new BookDetails { BookId = GetId("9781503290563"), Genre = "Romance", PageCount = 279, Language = "English", Format = "Paperback", CoverImageUrl = "https://covers.openlibrary.org/b/isbn/9781503290563-L.jpg" },
                new BookDetails { BookId = GetId("9780316769488"), Genre = "Classic", PageCount = 214, Language = "English", Format = "Paperback", CoverImageUrl = "https://covers.openlibrary.org/b/isbn/9780316769488-L.jpg" },
                new BookDetails { BookId = GetId("9780547928227"), Genre = "Fantasy", PageCount = 310, Language = "English", Format = "Paperback", CoverImageUrl = "https://covers.openlibrary.org/b/isbn/9780547928227-L.jpg" },
                new BookDetails { BookId = GetId("9781451673319"), Genre = "Science Fiction", PageCount = 158, Language = "English", Format = "Paperback", CoverImageUrl = "https://covers.openlibrary.org/b/isbn/9781451673319-L.jpg" },
                new BookDetails { BookId = GetId("9781503280786"), Genre = "Adventure", PageCount = 635, Language = "English", Format = "Paperback", CoverImageUrl = "https://covers.openlibrary.org/b/isbn/9781503280786-L.jpg" },
                new BookDetails { BookId = GetId("9780141441146"), Genre = "Gothic", PageCount = 500, Language = "English", Format = "Paperback", CoverImageUrl = "https://covers.openlibrary.org/b/isbn/9780141441146-L.jpg" },
                new BookDetails { BookId = GetId("9780140268867"), Genre = "Epic", PageCount = 560, Language = "English", Format = "Paperback", CoverImageUrl = "https://covers.openlibrary.org/b/isbn/9780140268867-L.jpg" },
            };
